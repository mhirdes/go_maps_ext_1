...
t3lib_extMgm::addLLrefForTCAdescr('tx_gomapsext_domain_model_category', 'EXT:go_maps_ext/Resources/Private/Language/locallang_csh_tx_gomapsext_domain_model_category.xml');
t3lib_extMgm::allowTableOnStandardPages('tx_gomapsext_domain_model_category');
$TCA['tx_gomapsext_domain_model_category'] = array(
	'ctrl' => array(
		'title'	=> 'LLL:EXT:go_maps_ext/Resources/Private/Language/locallang_db.xml:tx_gomapsext_domain_model_category',
		'label' => 'name',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_gomapsext_domain_model_category.png'
	),
);
