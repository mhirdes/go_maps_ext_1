...
class Tx_GoMapsExt_Domain_Model_Address extends Tx_Extbase_DomainObject_AbstractEntity {
	 ...
	 * categories
	 *
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_GoMapsExt_Domain_Model_Category>
	 * @lazy
	 */
	 ...
	 * Adds a Category
	 *
	 * @param Tx_GoMapsExt_Domain_Model_Address $category
	 * @return void
	 */
	public function addCategory(Tx_GoMapsExt_Domain_Model_Category $category) {
	 ...
	 * Removes a Category
	 *
	 * @param Tx_GoMapsExt_Domain_Model_Category $categoryToRemove The Category to be removed
	 * @return void
	 */
	public function removeCategory(Tx_GoMapsExt_Domain_Model_Category $categoryToRemove) {
	 ...
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_GoMapsExt_Domain_Model_Category> $categories
	 */
	 ...
	 * Sets the categories
	 *
	 * @param Tx_Extbase_Persistence_ObjectStorage<Tx_GoMapsExt_Domain_Model_Category> $categories
	 * @return void
	 */
